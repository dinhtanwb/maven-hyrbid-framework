...
public class TC_01_Lv18_Manage_Test_Data_Apply_All_Report extends BaseTest {
	...
	public void TC_01_Register_Account(Method method) {
		...
		ExtentTestManager.getTest().log(Status.INFO, "Register Account - Step 02: Select Gender radio value is: " + gender);
	...
	@Test
	public void TC_03_Verify_Data(Method method) {
		ExtentTestManager.startTest(method.getName(), "TC_03_Verify_Data");
		ExtentTestManager.getTest().log(Status.INFO, "Verify Data - Step 01: Verify 'FirstName' TextBox");
		Assert.assertEquals(customerInfo.verifyTextBoxByID(driver, "FirstName", "value"), firstName + "1");
