...
public class TC_01_Lv18_Manage_Test_Data_II extends BaseTest {

	@Parameters({"browser", "url", "firstName", "lastName", "password", "emailAddress"})
	@BeforeClass
	public void beforeClass(String browserName, String url, String firstName, String lastName, String password, String emailAddress) {
