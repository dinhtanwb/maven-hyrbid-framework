...
import com.nopcommerce.dataExternal.DataJson;
...
public class TC_01_Lv18_Manage_Test_Data_IV extends BaseTest {
	...
	public void TC_01_Register_Account() {
		...
		log.info("Register Account - Step 07: Input into FirstName textbox value is: " + dataJson.getFirstName());
		registerPage.inputTextBoxByID(driver, "FirstName", dataJson.getFirstName());

		log.info("Register Account - Step 08: Input into LastName textbox value is: " + dataJson.getLastName());
		registerPage.inputTextBoxByID(driver, "LastName", dataJson.getLastName());

		log.info("Register Account - Step 09: Input into Email textbox value is: " + dataJson.getEmail());
		registerPage.inputTextBoxByID(driver, "Email", dataJson.getEmail());

		log.info("Register Account - Step 10: Input into Password textbox value is: " + dataJson.getPassword());
		registerPage.inputTextBoxByID(driver, "Password", dataJson.getPassword());

		log.info("Register Account - Step 11: Input into Confirm Password textbox value is: " + dataJson.getPassword());
		registerPage.inputTextBoxByID(driver, "ConfirmPassword", dataJson.getPassword());
	...
	public void TC_02_Login_Page() {
		...
		log.info("Login Account - Step 02: Input to email address value is: " + dataJson.getEmail());
		loginPage.inputTextBoxByID(driver, "Email", dataJson.getEmail());

		log.info("Login Account - Step 03: Input to email password value is:" + dataJson.getPassword());
		loginPage.inputTextBoxByID(driver, "Password", dataJson.getPassword());
	...
	public void TC_03_Verify_Data() {
		...
		Assert.assertEquals(customerInfo.verifyTextBoxByID(driver, "FirstName", "value"), dataJson.getFirstName());
		
		log.info("Verify Data - Step 02: Verify 'LastName' TextBox");
		Assert.assertEquals(customerInfo.verifyTextBoxByID(driver, "LastName", "value"), dataJson.getLastName());
		
		log.info("Verify Data - Step 03: Verify 'EmailAddress' TextBox");
		Assert.assertEquals(customerInfo.verifyTextBoxByID(driver, "Email", "value"), dataJson.getEmail());
