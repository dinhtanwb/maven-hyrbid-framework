...
//Giải quyêt được vấn đề khởi tạo new nhiều lần
//Khởi tạo object của mỗi trang nằm ở tầng page object của trang đó
//Vẫn còn call lại function nhìu lần. Vi phạm quy tắc DRY --> Sửa 1 chỗ phải đi maintain nhìu chỗ --> Mất thời gian và có khi bị miss
...
public class TC_01_Lv06_Page_Generator_Manager_II extends BaseTest {
	WebDriver driver;
