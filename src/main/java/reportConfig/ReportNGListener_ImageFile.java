...
public class ReportNGListener_ImageFile extends BaseTest implements ITestListener {
	...
	public String captureScreenshot(WebDriver driver, String screenshotName) {
		try {
			...
			String screenPath = GlobalConstances.REPOTNG_IMAGE + screenshotName + "_" + formater.format(calendar.getTime()) + ".png";
